...
function Nav() {
    ...
    return (
        <nav className='nav nav-tabs' style={{ fontSize: '1.2rem' }}>
            <Link className={location.pathname === '/' ? 'nav-link active' : 'nav-link'} to="/react-portfolio" style={{ color: 'white', backgroundColor: location.pathname === '/' ? 'black' : '' }}>
            ...
            <a className='nav-item' target="_blank" href={resumeImage} style={{ color: 'white', backgroundColor: location.pathname === '/ID.pdf' ? 'black' : '' }}>
